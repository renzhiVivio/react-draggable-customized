...
export function createCSSTransform(controlPos: ControlPosition, positionOffset: PositionOffsetControlPosition, rotation:number): Object {
  const translation = getTranslation(controlPos, positionOffset, 'px', rotation);
...
export function getTranslation({x, y}: ControlPosition, positionOffset: PositionOffsetControlPosition, unitSuffix: string, rotation:number): string {
